...
# df = pbp_full
df = pd.read_csv("https://github.com/fritschcm272/UWW_MensBBALL/blob/d242ec9d449fc5ca99fef1b752727e4a0367552c/warhawks.csv?raw=true")

df = df.sort_values(['UWW_LINEUP','Date'])
